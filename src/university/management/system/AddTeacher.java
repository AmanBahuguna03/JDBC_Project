...
public class AddTeacher extends JFrame implements ActionListener {
	...
	AddTeacher()
	{
		...
		lblempid.setFont(new Font("seriff", Font.BOLD,20));
		add(lblempid);
		
		labelempid = new JLabel("101"+first4);
		labelempid.setBounds(200,200,200,30);
		labelempid.setFont(new Font("seriff", Font.BOLD,20));
		add(labelempid);
		...
		lblqualification.setFont(new Font("seriff", Font.BOLD,20));
		...
		lbldept.setFont(new Font("seriff", Font.BOLD,20));
		add(lbldept);
